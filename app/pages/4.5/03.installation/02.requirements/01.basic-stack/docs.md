...
> [!WARNING]
> As of UserFrosting 4.5.0, support for PHP version 7.2 is officially deprecated. While you can still use UserFrosting 4.4.x with PHP 7.2, upgrading to PHP 7.3 or above is highly recommended as PHP 7.2 have, or will, reach [End Of Life](http://php.net/supported-versions.php) soon.
