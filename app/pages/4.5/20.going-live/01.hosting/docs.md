...
description: UserFrosting can easily be deployed to any server with PHP 7.2 or higher, a compatible database, and a webserver application (nginx, Apache, or IIS).
---
