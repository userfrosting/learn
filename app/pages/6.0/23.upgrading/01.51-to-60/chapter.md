...
Welcome to **UserFrosting 6.0**! This major release represents a significant evolution of the framework, bringing a fresh and modern UI, improved performance, and modern build tools.
...
2. Search existing [GitHub issues](https://github.com/userfrosting/userfrosting/issues)
