...
>
> Please see:
> - [Advanced Usage](/assets-vite/advanced) for TypeScript, Vue 3, CSS preprocessors, and optimization
> - [Sprinkle Assets](/assets-vite/advanced/sprinkle-assets) for building sprinkles as libraries
> - [Migration Guide](/assets-vite/advanced/migration) to migrate from Webpack Encore
