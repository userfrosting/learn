...
- **[Tables](/ui-theming/tables)**: Display data in sortable, filterable tables
- **[Collections](/ui-theming/collections)**: Manage dynamic lists of items
- **[Alerts](/ui-theming/alerts)**: Show notifications to users
