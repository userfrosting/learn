...
Learn how to [migrate from Webpack Encore](/assets-vite/advanced/migration) if you have an existing UserFrosting 5 project, or explore the [Sprinkle System](/structure/sprinkles) in more depth.
