...
Explore the [Vite Configuration](/assets-vite/vite-configuration) guide to learn more about Vite configuration, or jump to [Advanced Usage](/assets-vite/advanced) for optimization techniques.
