...
Now that you understand Vue's role in UserFrosting, you're ready to learn how to [use assets in your application](/assets-vite/using-assets). The next page covers how to reference and load your Vue components, styles, and other assets in UserFrosting's Twig templates.

For hands-on Vue development, check out the [Advanced Topics](/assets-vite/advanced) section, which covers Vue 3 Single File Components, TypeScript integration, and building complex interactive features.
