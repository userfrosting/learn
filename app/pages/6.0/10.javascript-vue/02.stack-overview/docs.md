...
- **[Export Variables](/javascript-vue/exporting-variables)**: Pass data from PHP to JavaScript
- **[Build Vue Components](/javascript-vue/vue-components)**: Create reactive user interfaces
- **[Work with Forms](/ui-theming/forms)**: Handle user input and validation
- **[Create Tables](/ui-theming/tables)**: Display and manipulate data
- **[Show Alerts](/ui-theming/alerts)**: Provide user feedback
