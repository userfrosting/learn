...
Learn about managing assets across [multiple sprinkles](/assets-vite/advanced/sprinkle-assets) or how to [migrate from Webpack](/assets-vite/advanced/migration).
