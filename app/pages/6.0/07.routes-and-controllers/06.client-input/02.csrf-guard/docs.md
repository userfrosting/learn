...
Requests for [raw assets](/assets-vite/using-assets) are automatically exempted from CSRF protection in the `config` [service](/dependency-injection/default-services#userfrosting-config-config).
