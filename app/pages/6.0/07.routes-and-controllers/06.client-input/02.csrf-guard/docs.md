...
Requests for [raw assets](/assets-vite/using-assets) are automatically exempted from CSRF protection in the `config` [service](/services/default-services#userfrosting-config-config).
