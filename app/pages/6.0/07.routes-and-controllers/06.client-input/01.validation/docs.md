...
> If you visit the page `/account/register` and use "View Source", you can see how the validation rules have been injected into the page. See [exporting variables](/javascript-vue/exporting-variables#page-specific-variables) for more details on exporting server-side variables to Javascript variables on a page.
