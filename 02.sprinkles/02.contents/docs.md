...
The `assets` directory contains all of the Javascript, CSS, images, and other static content for your site.  See [section 5.2](/building-pages/assets) for more information about asset management and usage.
